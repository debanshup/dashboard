"use client"
import ImpactOverCountryPieChart from '@/app/components/ImpactPieChart'
import { fetchConstants, fetchData } from '@/app/services/dataService';
import { useGlobalStore } from '@/store/useGlobalStore';
import React, { useEffect } from 'react'

const CountryVsImpact = () => {
  ...
  return (
    <ImpactOverCountryPieChart data={data} />
  )
}

export default CountryVsImpact