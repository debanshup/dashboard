"use client";
import PestlePieChart from "@/app/components/PieChart";
import { fetchConstants, fetchData } from "@/app/services/dataService";
import { useGlobalStore } from "@/store/useGlobalStore";
import React, { useEffect } from "react";

const PestleVsImpact = () => {
  const { data, filters, setData, constants, setFilters, setConstants } =
    useGlobalStore();
  ...
  return <PestlePieChart data={data} />;
};

export default PestleVsImpact;
